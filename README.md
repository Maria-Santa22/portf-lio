...
# 👩‍💻 Maria Santa Pereira Nunes
### Portfólio Pessoal

*Técnica em Informática para Internet · Rio Branco - AC*

[![Email](https://img.shields.io/badge/Email-mariams.santaa%40gmail.com-4FD1C5?style=flat-square)](mailto:mariams.santaa@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-Maria--Santa22-24374F?style=flat-square&logo=github)](https://github.com/Maria-Santa22)
...
| Seção | Conteúdo |
|---|---|
| 🙋 Sobre | Apresentação e formação |
| 💼 Experiência | Monitoria no IFAC e atuação em frutaria |
| 🛠️ Habilidades | HTML, CSS, JavaScript, PHP, Python, SQL, MySQL, Git, GitHub, Django |
